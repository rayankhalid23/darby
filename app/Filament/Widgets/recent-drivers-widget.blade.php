        ...
        <div class="overflow-x-auto">
            <table class="w-full text-right text-xs">
                <thead class="bg-slate-50 text-slate-500 font-bold border-b border-slate-200">
                    <tr>
                        <th className="p-3.5 px-4">السائق</th>
                        <th className="p-3.5 px-4">المدينة / المنطقة</th>
                        <th className="p-3.5 px-4">نوع المركبة</th>
                        <th className="p-3.5 px-4">الحالة الحالية</th>
                        <th className="p-3.5 px-4">إجمالي الرحلات</th>
